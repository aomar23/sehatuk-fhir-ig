...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense">
      ...
      <sch:assert test="count(f:extension[@url = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-dispense-status']) &gt;= 1">extension with URL = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-dispense-status': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-dispense-status']) &lt;= 1">extension with URL = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-dispense-status': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:whenPrepared) &gt;= 1">whenPrepared: minimum cardinality of 'whenPrepared' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense/f:authorizingPrescription">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-order-number']) &gt;= 1">extension with URL = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-order-number': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-order-number']) &lt;= 1">extension with URL = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-order-number': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:reference) &lt;= 1">reference: maximum cardinality of 'reference' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:identifier) &gt;= 1">identifier: minimum cardinality of 'identifier' is 1</sch:assert>
      <sch:assert test="count(f:identifier) &lt;= 1">identifier: maximum cardinality of 'identifier' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:authorizingPrescription/f:identifier</sch:title>
  ...
  <sch:pattern>
    <sch:title>MedicationDispense.authorizingPrescription.identifier.extension</sch:title>
    <sch:rule context="f:MedicationDispense/f:authorizingPrescription/f:identifier/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.authorizingPrescription.identifier.use</sch:title>
    <sch:rule context="f:MedicationDispense/f:authorizingPrescription/f:identifier/f:use">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.authorizingPrescription.identifier.type</sch:title>
    <sch:rule context="f:MedicationDispense/f:authorizingPrescription/f:identifier/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.authorizingPrescription.identifier.system</sch:title>
    <sch:rule context="f:MedicationDispense/f:authorizingPrescription/f:identifier/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.authorizingPrescription.identifier.value</sch:title>
    <sch:rule context="f:MedicationDispense/f:authorizingPrescription/f:identifier/f:value">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.authorizingPrescription.identifier.period</sch:title>
    <sch:rule context="f:MedicationDispense/f:authorizingPrescription/f:identifier/f:period">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationDispense.authorizingPrescription.identifier.assigner</sch:title>
