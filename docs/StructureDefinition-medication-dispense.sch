...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense">
      ...
      <sch:assert test="count(f:extension[@url = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-dispense-status']) &gt;= 1">extension with URL = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-dispense-status': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-dispense-status']) &lt;= 1">extension with URL = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-dispense-status': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense/f:authorizingPrescription">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-order-number']) &gt;= 1">extension with URL = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-order-number': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-order-number']) &lt;= 1">extension with URL = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-order-number': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:reference) &lt;= 1">reference: maximum cardinality of 'reference' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
