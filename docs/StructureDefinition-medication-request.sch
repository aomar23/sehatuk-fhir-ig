...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-type']) &gt;= 1">extension with URL = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-type': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-type']) &lt;= 1">extension with URL = 'http://roadxcore.com/fhir/v1/StructureDefinition/extension-prescription-type': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>MedicationRequest.requester.identifier.extension</sch:title>
    <sch:rule context="f:MedicationRequest/f:requester/f:identifier/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.requester.identifier.use</sch:title>
    <sch:rule context="f:MedicationRequest/f:requester/f:identifier/f:use">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.requester.identifier.type</sch:title>
    <sch:rule context="f:MedicationRequest/f:requester/f:identifier/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.requester.identifier.system</sch:title>
    <sch:rule context="f:MedicationRequest/f:requester/f:identifier/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.requester.identifier.value</sch:title>
    <sch:rule context="f:MedicationRequest/f:requester/f:identifier/f:value">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.requester.identifier.period</sch:title>
    <sch:rule context="f:MedicationRequest/f:requester/f:identifier/f:period">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.requester.identifier.assigner</sch:title>
