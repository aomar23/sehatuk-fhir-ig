...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-type']) &gt;= 1">extension with URL = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-type': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-type']) &lt;= 1">extension with URL = 'https://www.sehatuk.ae/uae-fhir/r4/StructureDefinition/extension-prescription-type': maximum cardinality of 'extension' is 1</sch:assert>
